...
<div class="holder">
    <div class="bg">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-1 lead col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
          <h1>WELCOME TO DESIGN LIFE</h1>
          <p>A podcast about design and side projects for motivated creators</p>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-8 col-lg-offset-1 col-md-8 col-md-offset-2 convert">
          ...
          <form action="http://designlife.us12.list-manage1.com/subscribe/post" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" novalidate="">
                ...
                <div class="mobile-fix col-lg-8 col-xs-12 col-sm-12 form" style="padding-left:0px;"><input type="text" class="form-control" id="email" placeholder="EMAIL ADDRESS" name="EMAIL" id="mce-EMAIL"/></div>
                <div class="mobile-fix col-lg-4 col-xs-12 col-sm-12 form" style="padding-right:0px;"><button class="button">Sign me up!</button></div>
            </form>
          </div>
        </div>
      </div>
      <div class="row bump">
        <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-2 col-sm-6 left">
          <div class="creators ">
